...
const routes: Ref<SimpleRoute[]> = ref([])
const current: Ref<SimpleRoute | null> = ref(null)
 ...
 * Tab点击
 */
const tabItemClick = (route: SimpleRoute) => {
 ...
 */
const closeBtnClick = (index: number, event: MouseEvent) => {
